...
export default function DeployPage() {
  ...
  return (
    <>
    {/* Enhanced rocket animation with dark mode support */}
      <style>{`
      ...
      <div className="flex max-w-6xl flex-col gap-2 p-2">
        ...
        <div className="sm:align-center sm:flex sm:flex-col">
          <div className="mb-4">{orgsLoading && <Loader2 className="h-4 w-4 animate-spin text-gray-600 dark:text-gray-400" />}</div>
          {projectsLoading && (
