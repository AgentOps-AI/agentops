...
export default function DeployPage() {
  ...
  useEffect(() => {
    ...
    const requiredOrgId = 'e8b96c19-acc6-4ca4-9158-0c06ca03ad4f'; // agenetops orgid
    const isInRequiredOrg = orgsForDropdown?.some(org => org.id === requiredOrgId);
    if (orgsForDropdown && !isInRequiredOrg) {
  ...
  return (
    <>
    {/* pls dont hate me bogle this is so the rocket does fun zoomie things */}
      <style>{`
      ...
      <div className="flex max-w-6xl flex-col gap-2 p-2">
        <h1 className="my-4 font-['Figtree'] text-[32px] font-bold text-gray-900 dark:text-white">
          Agent Hosting
        </h1>
                ...
                return (
                  <div key={orgId}>
                    ...
                    {moreProjects.length > 0 && (
                      <>
                        <span
                          className="flex items-center gap-1 mt-2 text-[14px] italic text-gray-500 dark:text-gray-400 cursor-pointer select-none font-['Figtree'] ml-6"
