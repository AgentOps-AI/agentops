...
<Steps>
  ...
  <Step title="Add 2 lines of code">
    ...
    <Tip>
      Importing and starting AgentOps client automatically logs all of your LLM calls to your dashboard
      along with the full chat history, cost, token count, etc.
    </Tip>
    <SupportedModels />
  </Step>
