...
<CardGroup cols={2}>
  ...
  <Card title="AG2" icon={<img src="https://www.github.com/agentops-ai/agentops/blob/main/docs/images/external/autogen/ag2_blue.svg?raw=true" alt="AG2"/>} iconType="image" href="/v1/integrations/autogen" />
...
<Check>[Give us a star](https://github.com/AgentOps-AI/agentops) to bookmark us on GitHub, save for later 🖇️)</Check>
