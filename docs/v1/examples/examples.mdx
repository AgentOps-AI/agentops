...
<CardGroup cols={2}>
    <Card title="Simple Agent" icon="person-carry-box" iconType="solid" href="/v1/examples/simple_agent">
    ...
    <Card title="LangChain Example" icon="link" href="/v1/examples/langchain">
