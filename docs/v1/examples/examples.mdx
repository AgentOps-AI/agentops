...
<CardGroup cols={2}>
    ...
    <Card title="Multi-Agent" icon="people-arrows" iconType="solid" href="/v1/examples/multi_agent">
        Jupyter Notebook with a simple multi-agent design
    </Card>
    <Card title="Multi Session" icon="computer" iconType="solid" href="/v1/examples/multi_session">
...
<CardGroup cols={2}>
    <Card title="AI21" icon="brain" iconType="solid" href="/v1/integrations/ai21">
    ...
    <Card title="AutoGen" icon="microsoft" iconType="solid" href="/v1/integrations/autogen">
    ...
    <Card title="Llama Stack" icon="hgi-cheese-cake-02" iconType="hgi-twotone" href="/v1/integrations/llama_stack">
        Create an agent to search the web using Brave Search and find the winner of NBA western conference semifinals 2014
    </Card>
    <Card title="LiteLLM" icon="hgi-speed-train-02" iconType="hgi-stroke hgi-sharp" href="/v1/integrations/litellm">
