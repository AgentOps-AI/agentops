...
<CardGroup cols={2}>
    ...
    <Card title="Llama Stack" icon="cheese-cake-02" iconType="twotone" href="/v1/integrations/llama_stack">
        Create an agent to search the web using Brave Search and find the winner of NBA western conference semifinals 2014
    </Card>
    <Card title="LiteLLM" icon="speed-train-02" iconType="stroke-sharp" href="/v1/integrations/litellm">
