...
<CardGroup cols={2}>
    ...
    <Card title="Cohere" icon={<img src="https://www.github.com/agentops-ai/agentops/blob/main/docs/images/external/cohere/Cohere-Logo-Mono Volcanic Black-RGB.png?raw=true" alt="Cohere" />} iconType="image" href="/v1/integrations/cohere">
    ...
    <Card title="Llama Stack" icon={<img src="https://www.github.com/agentops-ai/agentops/blob/main/docs/images/external/llama_stack/llama-icon.png?raw=true" alt="Llama Stack" />} iconType="image" href="/v1/integrations/llama_stack">
        Create an agent to search the web using Brave Search and find the winner of NBA western conference semifinals 2014
    </Card>
    <Card title="LiteLLM" icon={<img src="https://www.github.com/agentops-ai/agentops/blob/main/docs/images/external/litellm/train-icon.png?raw=true" alt="LiteLLM" />} iconType="image" href="/v1/integrations/litellm">
