...
- Decorators
  - With [Decorators](/v1/concepts/decorators), the SDK can add code to your existing functions and classes.
- Process monitoring
...
For more documentation on using multiple concurrent sessions, please see [Sessions](/v1/concepts/sessions) and [FastAPI Example](/v1/examples/fastapi).
