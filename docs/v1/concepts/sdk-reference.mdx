...
{/* TODO: This isn't rendering. Filed ticket with Mintlify
https://github.com/mintlify/docs/issues/183
*/}
<SupportedModels />
...
Start a new [Session](https://docs.agentops.ai/v1/details/sessions) for recording events.

**Parameters**:

- `tags` (List[str], optional): Tags for the session.
- `config` ([Configuration](https://docs.agentops.ai/v1/details/sdk-reference#configuration), optional): Client configuration object.
...
Stop instrumenting LLM calls. This is typically used by agent frameworks (i.e. [CrewAI](https://docs.agentops.ai/v1/integrations/crewai),
[autogen](https://docs.agentops.ai/v1/integrations/autogen)) to stop using the AgentOps auto instrumentation of LLM libraries like OpenAI. This
...
[Reference](https://docs.agentops.ai/v1/details/langchain-callback-handler)
