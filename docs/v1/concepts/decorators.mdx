...
Learn more about tracking agents [here](/v1/details/tracking-agents).

## `@track_function()`
Sometimes your agent system will use functions that are important to track as [`Actions`](/v1/events#actionevent).

Adding this decorator above any function will allow every instance of that function call to be tracked and displayed
in your [Session](v1/details/sessions) Drill-Down on the dashboard.
