---
title: Gemini
description: "AgentOps provides first class support for Google's Gemini family of models"
---
...
<Note>
  `google-generativeai>=0.1.0` is currently supported. The provider is automatically detected and initialized when you call `agentops.init()`.
</Note>
