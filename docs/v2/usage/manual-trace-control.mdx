...
> **📖 For comprehensive documentation on `update_trace_metadata`, including detailed examples, best practices, and advanced use cases, see [Update Trace Metadata](/v2/usage/update-trace-metadata).**
