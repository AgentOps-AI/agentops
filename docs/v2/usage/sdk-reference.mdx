...
For comprehensive documentation, examples, and best practices, see [Update Trace Metadata](/v2/usage/update-trace-metadata).

For additional examples and use cases, see [Manual Trace Control](/v2/usage/manual-trace-control#updating-trace-metadata-during-execution).
