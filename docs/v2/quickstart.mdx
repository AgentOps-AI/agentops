...
<Steps>
  ...
  <Step title="Add 2 lines of code">
    ...
    <Tip>
      That's it! These two lines automatically instrument your code and start tracking sessions.
    </Tip>
    
    If you need more control over when sessions start, you can set `auto_start_session=False`:
    ...
    <CodeGroup>
      ...
      # Later, start sessions explicitly:
