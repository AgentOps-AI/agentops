...
```python
load_dotenv()
os.environ["AGENTOPS_API_KEY"] = os.getenv("AGENTOPS_API_KEY", "your_agentops_api_key_here") # MDX uses "your_agentops_api_key_here", notebook "your_api_key_here" - keeping MDX for consistency
os.environ["ANTHROPIC_API_KEY"] = os.getenv("ANTHROPIC_API_KEY", "your_anthropic_api_key_here") # MDX uses "your_anthropic_api_key_here", notebook "your_anthropic_api_key_here"
```
