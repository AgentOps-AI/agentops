...
description: 'OpenAI Agents Patterns Demonstration'
---
{/*  SOURCE_FILE: examples/openai_agents/agent_patterns.ipynb  */}

_View Notebook on <a href={'https://github.com/AgentOps-AI/agentops/blob/main/examples/openai_agents/agent_patterns.ipynb'} target={'_blank'}>Github</a>_
