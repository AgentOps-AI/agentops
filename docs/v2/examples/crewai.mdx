...
def run():
    ...
    """
    # Start AgentOps trace for this run
    tracer = agentops.start_trace(trace_name="CrewAI Job Posting", tags=["crewai", "job-posting"])
    ...
    try:
        ...
        agentops.end_trace(tracer, end_state="Failed")
        raise
