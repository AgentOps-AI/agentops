...
---
{/*  SOURCE_FILE: examples/llamaindex/llamaindex_example.ipynb  */}

_View Notebook on <a href={'https://github.com/AgentOps-AI/agentops/blob/main/examples/llamaindex/llamaindex_example.ipynb'} target={'_blank'}>Github</a>_
