...
<CardGroup>
  ...
  <Card title="Agno" icon="cpu" href="/v2/examples/agno">
  ...
  <Card title="smolagents" icon={<img src="https://github.com/AgentOps-AI/agentops/blob/main/docs/images/external/huggingface/hf-logo.png?raw=true" alt="smolagents" />} iconType="image" iconType="solid" href="/v2/integrations/smolagents">
