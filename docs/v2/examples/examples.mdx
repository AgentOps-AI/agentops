...
<CardGroup>
  <Card title="Update Trace Metadata" icon="tags" href="/v2/usage/update-trace-metadata">
    Learn how to dynamically update metadata on running traces for progress tracking and contextual information
  </Card>

  <Card title="Manual Trace Control" icon="hand" href="/v2/usage/manual-trace-control">
    Advanced trace management with start_trace and end_trace methods
  </Card>

  <Card title="Decorators" icon="at" href="/v2/usage/trace-decorator">
    Use decorators to automatically instrument your functions and methods
  </Card>
</CardGroup>
