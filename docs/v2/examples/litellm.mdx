---
title: 'LiteLLM Example'
description: 'Using LiteLLM with AgentOps for observing LLM calls'
mode: "wide"
---
...
[See our LiteLLM docs](/v2/integrations/litellm)
...
<CodeGroup>
  ```bash pip
  pip install -U litellm agentops python-dotenv
  ```
  ```bash poetry
  poetry add litellm agentops python-dotenv
  ```
  ```bash uv
  uv add litellm agentops python-dotenv
  ```
</CodeGroup>
