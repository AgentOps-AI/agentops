...
<CardGroup cols={2}>
  ...
  <Card title="Tool Use (Alternative)" icon="notebook" href="https://github.com/AgentOps-AI/agentops/blob/main/examples/anthropic/anthrophic-example-tool.ipynb" newTab={true}>
