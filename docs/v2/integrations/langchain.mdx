...
<CodeGroup>
```python Basic LangChain Integration
import os
from dotenv import load_dotenv
...
# AgentOps will automatically track the interactions.
# After running, visit app.agentops.ai to see your session.
```
</CodeGroup>

## Examples
<CardGroup cols={1}>
  <Card title="LangChain Callback Handler Notebook" icon="notebook" href="/v2/examples/langchain">
