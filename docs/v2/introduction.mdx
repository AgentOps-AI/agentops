...
AgentOps provides a Model Context Protocol server that enables AI assistants to directly query your trace and span data. This allows for powerful AI-driven debugging and analysis of your agents.

<Card title="Learn about MCP" icon="plug" href="/v2/concepts/mcp">
  Discover how MCP revolutionizes AI-tool interactions and how AgentOps leverages it
</Card>

<Card title="AgentOps MCP Server" icon="server" href="/v2/usage/mcp-server">
  Set up the AgentOps MCP server to enable AI-assisted debugging
</Card>
