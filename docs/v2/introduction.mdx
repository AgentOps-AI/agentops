...
Prefer asking your IDE? Install the Mintlify <strong>MCP Docs Server</strong> for AgentOps to chat with the docs while you code:

```bash
npx mint-mcp add agentops
```

Read more in the <a href="/v2/usage/mcp-docs">MCP Docs</a> guide.
</Note>
