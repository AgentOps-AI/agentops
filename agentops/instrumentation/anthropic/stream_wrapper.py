...
def messages_stream_wrapper(tracer, wrapped, instance, args, kwargs):
    ...
    if original_event_handler is not None:
        wrapped_handler = EventHandleWrapper(
            original_handler=original_event_handler,
            span=span
        )
            ...
            def __exit__(self, exc_type, exc_val, exc_tb):
                ...
                try:
                    ...
                    try:
                        ...
                        if hasattr(self.original_manager, "_MessageStreamManager__stream") and \
                           hasattr(self.original_manager._MessageStreamManager__stream, "_MessageStream__final_message_snapshot"):
                ...
                async def __aexit__(self, exc_type, exc_val, exc_tb):
                    ...
                    try:
                        ...
                        try:
                            ...
                            if hasattr(self.original_manager, "_AsyncMessageStreamManager__stream") and \
                               hasattr(self.original_manager._AsyncMessageStreamManager__stream, "_AsyncMessageStream__final_message_snapshot"):
