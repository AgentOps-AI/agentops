...
from agentops.instrumentation.frameworks.openai_agents import LIBRARY_NAME, LIBRARY_VERSION

from agentops.instrumentation.frameworks.openai_agents.attributes.model import (
    get_model_attributes,
    get_model_config_attributes,
)
from agentops.instrumentation.frameworks.openai_agents.attributes.completion import get_generation_output_attributes
...
def get_span_attributes(span_data: Any) -> AttributeMap:
    ...
    if span_type == "AgentSpanData":
        ...
        logger.debug(f"[agentops.instrumentation.frameworks.openai_agents.attributes] Unknown span type: {span_type}")
        attributes = {}
