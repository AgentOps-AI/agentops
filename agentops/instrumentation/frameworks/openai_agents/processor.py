...
class OpenAIAgentsProcessor:
    ...
    def on_trace_start(self, sdk_trace: Any) -> None:
        ...
        logger.debug(f"[agentops.instrumentation.frameworks.openai_agents] Trace started: {sdk_trace}")
    ...
    def on_trace_end(self, sdk_trace: Any) -> None:
        ...
        logger.debug(f"[agentops.instrumentation.frameworks.openai_agents] Trace ended: {sdk_trace}")
        self.exporter.export_trace(sdk_trace)

    def on_span_start(self, span: Any) -> None:
        """Called when a span starts in the Agents SDK."""

        logger.debug(f"[agentops.instrumentation.frameworks.openai_agents] Span started: {span}")
    ...
    def on_span_end(self, span: Any) -> None:
        ...
        logger.debug(f"[agentops.instrumentation.frameworks.openai_agents] Span ended: {span}")
        self.exporter.export_span(span)
