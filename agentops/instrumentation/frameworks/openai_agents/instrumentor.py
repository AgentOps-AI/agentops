...
from agentops.instrumentation.frameworks.openai_agents import LIBRARY_VERSION
...
class OpenAIAgentsInstrumentor(BaseInstrumentor):
    ...
    def _instrument(self, **kwargs):
        ...
        if self._tracer is None:
            ...
            self._tracer = trace.get_tracer("agentops.instrumentation.frameworks.openai_agents", LIBRARY_VERSION)
