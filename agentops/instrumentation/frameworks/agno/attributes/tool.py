...
def get_tool_execution_attributes(
    ...
    if args and len(args) > 0:
        ...
        if hasattr(function_call, "function") and function_call.function:
            ...
            if hasattr(function, "__name__"):
                ...
                attributes["agno.tool.function_name"] = func_name
                attributes["agno.tool.display_name"] = f"{func_name} (Tool)"
    ...
    if return_value is not None:
        ...
        if result_value is not None:
            ...
            attributes["agno.tool.execution_result_status"] = str(result_type)
