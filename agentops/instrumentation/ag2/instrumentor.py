                ...
                try:
                    ...
                    if tool_type == "function" and args:
                        ...
                        if isinstance(func_call, dict):
                            span.set_attribute(MessageAttributes.TOOL_CALL_NAME.format(i=0), func_call.get("name", "unknown"))
                            if "arguments" in func_call:
                                try:
                                    span.set_attribute(MessageAttributes.TOOL_CALL_ARGUMENTS.format(i=0), 
    ...
    def _capture_group_chat_summary(self, span, manager, result):
        ...
        try:
            ...
            if hasattr(manager.groupchat, "speaker_selection_method"):
                span.set_attribute("ag2.groupchat.speaker_selection_method",
