from taskweaver.module.event_emitter import SessionEventHandlerBase, TaskWeaverEvent, EventScope, SessionEventType, RoundEventType, PostEventType
import agentops
...
class TaskWeaverEventHandler(SessionEventHandlerBase):
    ...
    def handle_session(self, type: SessionEventType, msg: str, extra: Any, **kwargs: Any):
        agentops.record(agentops.ActionEvent(
            ...
            params={"message": msg},
            returns=str(extra) if extra else None
        ))
    ...
    def handle_round(self, type: RoundEventType, msg: str, extra: Any, round_id: str, **kwargs: Any):
        if type == RoundEventType.round_start:
            ...
            agentops.record(agentops.ErrorEvent(
                error_type="round_error",
                details=msg,
                logs={"round_id": round_id}
            ))
