...
def init(
    ...
    **kwargs,
    ...
    Args:
        ...
        exporter_endpoint (str, optional): Endpoint for the trace exporter. If none is provided, key will
            be read from the AGENTOPS_EXPORTER_ENDPOINT environment variable.
        metrics_exporter_endpoint (str, optional): Endpoint for the metrics exporter. If none is provided, key will
            be read from the AGENTOPS_METRICS_EXPORTER_ENDPOINT environment variable.
