...
class HttpClient:
    ...
    # Store project_id at class level for use in resource attributes
    ...
    def get_project_id(cls) -> Optional[str]:
        """
        Get the project ID extracted from the authentication response.
            ...
            def default_token_fetcher(key: str) -> str:
                ...
                try:
                    ...
                    if "project_id" in token_data:
                        cls._project_id = token_data["project_id"]
                        logger.debug(f"Extracted project_id: {cls._project_id}")
