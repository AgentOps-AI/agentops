...
class SpanAttributes:
    ...
    ASSOCIATION_PROPERTIES = "association.properties"

    # Prompts
    PROMPT_MANAGED = "prompt.managed"
    PROMPT_KEY = "prompt.key"
    PROMPT_VERSION = "prompt.version"
    PROMPT_VERSION_NAME = "prompt.version_name"
...
class EventAttributes(Enum):
    # Define your custom event attributes here
