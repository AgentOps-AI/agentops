...
class MessageAttributes:
    ...
    COMPLETION_TOOL_CALL_STATUS = "gen_ai.completion.{i}.tool_calls.{j}.status"  # Status of tool call {j} in completion {i}
    ...
    COMPLETION_ANNOTATION_START_INDEX = "gen_ai.completion.{i}.annotations.{j}.start_index" # Start index of the URL annotation {j} in completion {i}
    COMPLETION_ANNOTATION_END_INDEX = "gen_ai.completion.{i}.annotations.{j}.end_index" # End index of the URL annotation {j} in completion {i}
    COMPLETION_ANNOTATION_TITLE = "gen_ai.completion.{i}.annotations.{j}.title"  # Title of the URL annotation {j} in completion {i}
    COMPLETION_ANNOTATION_TYPE = "gen_ai.completion.{i}.annotations.{j}.type" # Type of the URL annotation {j} in completion {i}
    COMPLETION_ANNOTATION_URL = "gen_ai.completion.{i}.annotations.{j}.url" # URL link of the URL annotation {j} in completion {i}