...
def override_openai_v1_completion(tracker):
...
def override_openai_v1_async_completion(tracker):
    from openai.resources.chat import completions
    from openai.types.chat import ChatCompletion, ChatCompletionChunk
...
def undo_override_openai_v1_completion():
    global original_create
    from openai.resources.chat import completions
...
def undo_override_openai_v1_async_completion():
    global original_create_async
    from openai.resources.chat import completions
