...
export default async function PrivacyPolicy() {
  return (
    <div className="mx-auto max-w-4xl px-4 py-8">
      ...
      <p className="mb-4 mt-2">STAF, INC PRIVACY POLICY</p>
      <p className="mb-4 mt-2">
        STAF, INC (the “Company”) is committed to maintaining robust privacy protections for its
      ...
      <p className="mb-4 mt-2">
        ...
        accessed at www.agentops.ai and www.staf.ai.
      </p>
      <p className="mb-4 mt-2">
        Service” refers to the Company’s services accessed via the Site, in which users can view
        agents, test their agents, debug their agents, fix their agents, bring their agents to
        market, and sell their agents on an affiliate basis.
      </p>
      <p className="mb-4 mt-2">The terms “we,” “us,” and “our” refer to the Company.</p>
      <p className="mb-4 mt-2">“You” refers to you, as a user of our Site or our Service. </p>
      <p className="mb-4 mt-2">
        By accessing our Site or our Service, you accept our Privacy Policy and{' '}
        <Link style={{ color: 'blue' }} href="/tos.pdf">
          Terms of Use
        </Link>
        , and you consent to our collection, storage, use and disclosure of your Personal
        Information as described in this Privacy Policy.
      </p>
      <h2 className="text-xl font-semibold">I. INFORMATION WE COLLECT</h2>
      <p className="mb-4 mt-2">
        ...
        you submit and number of clicks. Personal Information includes your email, information from
        sign in provider, phone number, and any information required to make a purchase which you
        submit to us through the registration process at the Site.
      </p>
      <h3 className="text-lg font-semibold">1. Information collected via Technology</h3>
      <p className="mb-4 mt-2">
        ...
        Information, which may include any information that is used to sign up for an account or
        make a payment. However, in an effort to improve the quality of the Service, we track
        ...
        cookies to collect the following information: clicks, preferences, device specifications,
      ...
      <h3 className="text-lg font-semibold">3. Children’s Privacy</h3>
      <p className="mb-4 mt-2">
        ...
        have collected such information, please contact us at alex@agentops.ai.
      </p>
      <h2 className="text-xl font-semibold">II. HOW WE USE AND SHARE INFORMATION</h2>
      ...
      <p className="mb-4 mt-2">
        ...
        consent. We do share Personal Information with vendors who are performing services for the
        Company, such as the servers for our email communications who are provided access to user’s
        email address for purposes of sending emails from us. Those vendors use your Personal
        Information only at our direction and in accordance with our Privacy Policy.
      </p>
      <p className="mb-4 mt-2">
      ...
      <p className="mb-4 mt-2">
        ...
        Terms of Service, including investigation of potential violations; address fraud, security
        or technical concerns; or to protect against harm to the rights, property, or safety of our
      ...
      <h2 className="text-xl font-semibold">III. HOW WE PROTECT INFORMATION</h2>
      <p className="mb-4 mt-2">
      ...
      <p className="mb-4 mt-2">
        ...
        communications from us by emailing alex@agentops.ai of the Site. Please note that
        notwithstanding the promotional preferences you indicate by either unsubscribing or opting
        out at alex@agentops.ai, we may continue to send you administrative emails including, for
        example, periodic updates to our Privacy Policy.
      </p>
      <h2 className="text-xl font-semibold">V. LINKS TO OTHER WEBSITES</h2>
      <p className="mb-4 mt-2">
      ...
      <h2 className="text-xl font-semibold">VI. CHANGES TO OUR PRIVACY POLICY</h2>
      <p className="mb-4 mt-2">
      ...
      <h2 className="text-xl font-semibold">VII. GOOGLE DATA</h2>
      <p className="mb-4 mt-2">
        Google User Data The Service collects and uses Google User Data solely for the purpose of
        facilitating the function of servicing the User’s account. This data is used to provide the
        Service’s advertised functionality and enhance the user experience. OAuth Keys Upon
        successfully signing into a Google User account, the Service may securely retain OAuth keys
        to access and manage the User’s account for the sole purpose of providing the Service’s
        advertised functionality. These OAuth keys are stored in a secure database and are not
        shared with third parties. Third Party Partners The Service may use third party partners to
        provide additional functionality. These partners may have access to Google User Data for the
        sole purpose of providing the Service’s advertised functionality. Third party partners will
        only have access to the minimum amount of data required to provide the Service’s advertised
        functionality. AI Models Google data may be used in AI models both locally and hosted by
        third party partners. These models may utilize Google Data to extend training sets and
        become more capable over time. These models may be used to provide additional functionality
        to the Service’s advertised functionality. These models are used to provide improvements to
        the Service’s advertised functionality.
      </p>
      <h2 className="text-xl font-semibold">VIII. CONTACT US</h2>
      <p className="mb-4 mt-2">
        If you have any questions regarding this Privacy Policy or the practices of this Site,
        please contact us by sending an email to alex@agentops.ai.
      </p>
      <p className="mb-4 mt-2">
