...
from agentops.instrumentation.frameworks.openai_agents import LIBRARY_NAME

# Import common attribute functions
from agentops.instrumentation.frameworks.openai_agents.attributes.common import (
...
from agentops.instrumentation.frameworks.openai_agents.attributes.model import (
    get_model_attributes,
)

# Import completion processing functions
from agentops.instrumentation.frameworks.openai_agents.attributes.completion import (
    get_chat_completions_attributes,
    get_raw_response_attributes,
)

# Import token processing functions
from agentops.instrumentation.frameworks.openai_agents.attributes.tokens import (
    process_token_usage,
...
def mock_external_dependencies():
    ...
    with patch("json.dumps", side_effect=json_dumps_wrapper):
        with patch("importlib.metadata.version", return_value="1.0.0"):
            with patch("agentops.instrumentation.frameworks.openai_agents.LIBRARY_NAME", "openai"):
                with patch("agentops.instrumentation.frameworks.openai_agents.LIBRARY_VERSION", "1.0.0"):
                    yield
...
class TestOpenAIAgentsAttributes:
    ...
    def test_generation_span_with_agents_response(self):
        ...
        with patch(
            "agentops.instrumentation.frameworks.openai_agents.attributes.completion.model_to_dict",
