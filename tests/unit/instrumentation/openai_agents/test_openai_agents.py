...
class TestAgentsSdkInstrumentation:
    ...
    def test_response_api_span_serialization(self, instrumentation):
        ...
        with patch('agentops.instrumentation.openai_agents.attributes.completion.get_raw_response_attributes') as mock_response_attrs:
            ...
            with patch('agentops.instrumentation.openai_agents.attributes.completion.get_generation_output_attributes') as mock_gen_output:
            ...
            assert captured_attributes[MessageAttributes.COMPLETION_CONTENT.format(i=0)] == "The capital of France is Paris."
    ...
    def test_tool_calls_span_serialization(self, instrumentation):
        ...
        with patch('agentops.instrumentation.openai_agents.attributes.completion.get_raw_response_attributes') as mock_response_attrs:
            ...
            assert MessageAttributes.COMPLETION_CONTENT.format(i=0) in captured_attributes
            assert captured_attributes[MessageAttributes.COMPLETION_CONTENT.format(i=0)] == "I'll help you find the current weather for New York City."
    ...
    def test_process_agent_span_fixed(self, instrumentation):
        ...
        assert captured_attributes[WorkflowAttributes.FINAL_OUTPUT] == "I can help you with finding information, answering questions, and more."
