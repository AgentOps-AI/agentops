...
from agentops.instrumentation.frameworks.openai_agents.instrumentor import OpenAIAgentsInstrumentor
from agentops.instrumentation.frameworks.openai_agents.exporter import OpenAIAgentsExporter
from agentops.instrumentation.frameworks.openai_agents.processor import OpenAIAgentsProcessor
...
class TestAgentsSdkInstrumentation:
    ...
    def test_response_api_span_serialization(self, instrumentation):
        ...
        with patch(
            "agentops.instrumentation.frameworks.openai_agents.attributes.completion.get_raw_response_attributes"
            ...
            with patch(
                "agentops.instrumentation.frameworks.openai_agents.attributes.completion.get_generation_output_attributes"
            ) as mock_gen_output:
