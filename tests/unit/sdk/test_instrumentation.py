...
class TestBasicInstrumentation:
    ...
    def test_agent_instrumentation(self, instrumentation: InstrumentationTester):
        ...
        class TestSession:
            def __init__(self):
                ...
                if hasattr(self, '_session_span'):
                    ...
                    print(f"TestSession.__init__: Session span attributes: {self._session_span._attributes if hasattr(self._session_span, '_attributes') else 'No attributes'}")
        ...
        print("Exporting in-flight spans...")
